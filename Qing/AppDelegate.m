...
//    self.window.rootViewController = [[OrderViewController alloc] init];
...
- (void)lonin{
    ...
    imageView.frame = drawerController.view.bounds;
    [drawerController.view addSubview:imageView];
    ...
    drawerController.rightViewController = right;
    [drawerController.view sendSubviewToBack:imageView];
    UINavigationController *navi = [[UINavigationController alloc] initWithRootViewController:main];
//    [[UINavigationBar appearance] setBarTintColor:UIColorFromRGB(0x067AB5)];
//    [[UINavigationBar appearance] setBarTintColor:[UIColor clearColor]];

    [navi.navigationBar setBackgroundImage:[UIImage imageNamed:@"naviBg.png"] forBarMetrics:UIBarMetricsDefault];

    navi.navigationBar.translucent = YES;
    drawerController.centerViewController = navi;
    //    self.window.rootViewController = [[DetailViewsController alloc] init];
